...
int main() {
	...
	//std::cout << bot::navigation::collision_point({0.69, 45.56}, {57.66, 9.52}, {46.51, -37.9}, {-35.88, 48.1});
	bool colliding;
	double t = bot::navigation::time_of_closest_approach({50.54, 113.18}, {97.58, 123.26}, {20.57,-97.86}, {-18.27, -98.31}, 16, 20, colliding);
	std::cout << "Colliding: " << colliding << " Time: " << t << std::endl;
	std::cout << "Collision point: " << bot::navigation::point_of_collision({50.54, 113.18}, {97.58, 123.26}, {20.57,-97.86}, {-18.27, -98.31}, 16, 20, t) << std::endl;
}

...
namespace bot {
	namespace constants {
		...
		constexpr double DEFEND_RADIUS = hlt::constants::DOCK_RADIUS + hlt::constants::WEAPON_RADIUS +
		                                 hlt::constants::SHIP_RADIUS * 2; // TODO: wont work it there are enemy planets closeby

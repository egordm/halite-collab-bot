...
namespace bot {
	namespace navigation {
		...
		static double time_of_closest_approach(const hlt::Vector &p1, const hlt::Vector &p2, const hlt::Vector &v1, const hlt::Vector &v2,
		...
		static hlt::Vector point_of_collision(const hlt::Vector &p1, const hlt::Vector &p2, const hlt::Vector &v1, const hlt::Vector &v2,
